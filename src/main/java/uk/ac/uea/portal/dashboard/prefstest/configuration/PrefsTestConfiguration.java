package uk.ac.uea.portal.dashboard.prefstest.configuration;
 ...
 */
@Meta.OCD(  
		id = "uk.ac.uea.portal.dashboard.prefstest.configuration.PrefsTestConfiguration"
	)
public interface PrefsTestConfiguration {
